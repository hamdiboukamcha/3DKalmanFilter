...
public:
     ...
     */
    KalmanFilter3D(double dt, double process_noise_std, double measurement_noise_std);
...
private:
     ...
     */
    void matrixMultiply(const double A[6][6], const double B[6], double result[6]);
     ...
     */
    void matrixMultiply(const double A[6][6], const double B[6][6], double result[6][6]);
     ...
     * @param result 6x6 result matrix.
     */
    void matrixAdd(const double A[6][6], const double B[6][6], double result[6][6]);
     ...
     */
    void matrixAdd(const double A[3][3], const double B[3][3], double result[3][3]);
     ...
     * @param result 3x3 result matrix.
     */
    void matrixSubtract(const double A[3][3], const double B[3][3], double result[3][3]);
